...
module.exports = function() {
  return {
    ...
    // Get access to config value holding application name
    get_branding_title: function() {
      return config.get('branding:title')
    },

    // Get access to config value holding application contact email address
    get_branding_contactemail: function() {
      return config.get('branding:contactemail')
    },
    ...
    is_forceLeaveSelect: function(options) {
      if (config.get('options:forceleaveselect')) {
        return options.fn(this)
      }

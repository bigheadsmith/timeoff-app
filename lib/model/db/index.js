...
const databaseConfig = {
  ...
  retry: {
    ...
    max: parseInt(process.env.DB_RETRY_MAX) || 5, // maximum amount of tries
    timeout: parseInt(process.env.DB_RETRY_TIMEOUT) || 60000 // throw if a retry takes longer than this amount of miliseconds
  }
}

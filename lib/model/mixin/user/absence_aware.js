      ...
      self
        ...
        .then(employee => {
          ...
          if (effectiveLimit && effectiveLimit > 0) {
            let days_taken = employee.calculate_number_of_days_taken_from_allowance(
              {
                year: year.format('YYYY'),
                leave_type: leave_type,
                ignore_allowance: true
            ...
            let days_deducted = leave.get_deducted_days_number({
              year: year.format('YYYY'),
              user: employee,
              leave_type: leave_type,
              ignore_allowance: true
            })
            let would_be_used = days_taken + days_deducted

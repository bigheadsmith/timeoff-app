...
function isRegistrationAllowed() {
  const envRegOption = process.env.OPTIONS_REGISTRATION
  console.log(
    'Environment variable OPTIONS_REGISTRATION: ' + envRegOption
  )
...
module.exports = function (passport) {
  ...
  router.get('/login', (req, res) => {
    res.render('login', {
      ...
      contact_email_address: get_contact_email_address_for_anonymous_session(req),
    })
  })

...
function isRegistrationAllowed() {
  const regAllowed = config.get('options:allowregistration')
  console.log(
    'Environment variable OPTION_ALLOWREGISTRATION: ' + regAllowed
  )
  if (config.get('options:allowregistration')) {
    return true
  } else {
    return false
  }
...
module.exports = function(passport) {
  ...
  router.get('/login', (req, res) => {
    res.render('login', {
      ...
      allow_create_new_accounts: config.get('options:allowregistration'),
      title: 'Login  | TimeOff',

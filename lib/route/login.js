...
function isRegistrationAllowed() {
    ...
    console.log("Environment variable OPTION_ALLOW_NEW_REGISTRATIONS: " + envRegOption)
...
module.exports = function(passport) {
  ...
  router.get('/register', (req, res) => {
    ...
    let allow_reg = isRegistrationAllowed();
  ...
  router.post('/register', (req, res) => {
    ...
    */
    ...
    console.log('Registering new user', email, slack_username, name, lastname, company_name, country_code, timezone)
    req.app
      .get('db_model')
